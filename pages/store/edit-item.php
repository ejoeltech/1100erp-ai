...
$pageTitle = 'Edit Item - ' . htmlspecialchars($item['name']);
...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-900">Edit Store Item</h2>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="itemName" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" value="<?php echo htmlspecialchars($item['name']); ?>">
                </div>
                
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">SKU / Item Code</label>
                    <input type="text" id="itemSku" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" value="<?php echo htmlspecialchars($item['sku'] ?? ''); ?>">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="itemDescription" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all resize-none"><?php echo htmlspecialchars($item['description'] ?? ''); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" id="itemPrice" inputmode="decimal" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all font-bold" value="<?php echo number_format($item['price'] ?? 0, 0, '.', ','); ?>" onfocus="unformatInput(this)" onblur="formatInput(this)">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Cost Price (₦)</label>
                    <input type="text" id="itemCostPrice" inputmode="decimal" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all text-gray-600" value="<?php echo number_format($item['cost_price'] ?? 0, 0, '.', ','); ?>" onfocus="unformatInput(this)" onblur="formatInput(this)">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Unit</label>
                    <input type="text" id="itemUnit" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" value="<?php echo htmlspecialchars($item['unit'] ?? ''); ?>">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="itemStock" inputmode="decimal" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" value="<?php echo number_format($item['stock_quantity'] ?? 0, 0, '.', ','); ?>" onfocus="unformatInput(this)" onblur="formatInput(this)">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Minimum Stock Level</label>
                    <input type="text" id="itemMinStock" inputmode="decimal" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" value="<?php echo number_format($item['minimum_stock'] ?? 0, 0, '.', ','); ?>" onfocus="unformatInput(this)" onblur="formatInput(this)">
                </div>
                <div>
...
document.getElementById('itemForm').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        if (res.success) {
            Swal.fire({ icon: 'success', title: 'Updated!', text: 'Item details have been updated.', showConfirmButton: false, timer: 1500 });
